...
class DatosC {
    ...
    public DatosC(int id, String titulo, String genero_id, String cantante_id, String descripcion, String created_at, String updated_at, String deleted_at, String archivo, String imagen_cancion) {
        this.id = id;
        this.titulo = titulo;
