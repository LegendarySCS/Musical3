...
public class DatosArtistasCanciones extends ArrayAdapter {

    private static final String URL_BASE = "http://168.62.42.172/ciudadmusical/obtenercancionesporartista/";
    ...
    private static final String TAG = "DatosArtistasCanciones";
    JsonArrayRequest jsArrayRequest;

    ArrayList<DatosArtistasCancionesC> items;
    Context context;
    ...
    public DatosArtistasCanciones(Context context, String tab, final View View22) {
        super(context, 0);
        ...
        jsArrayRequest = new JsonArrayRequest(Request.Method.GET,URL_BASE+tab,(String) null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        items = (ArrayList<DatosArtistasCancionesC>) parseJson(response);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        DatosArtistasCancionesC item = items.get(position);
        ...
        ImageRequest request = new ImageRequest(
                ...
                new Response.ErrorListener() {
                    public void onErrorResponse(VolleyError error) {
                        imagenPost.setImageResource(R.drawable.musica);
    ...
    public List<DatosArtistasCancionesC> parseJson(JSONArray jsonObject) {
        // Variables locales
        List<DatosArtistasCancionesC> posts = new ArrayList<>();
        ...
        for (int i = 0; i < jsonObject.length(); i++) {
            ...
            try {
                ...
                DatosArtistasCancionesC post = new DatosArtistasCancionesC(
                        objeto.getInt("id"),
