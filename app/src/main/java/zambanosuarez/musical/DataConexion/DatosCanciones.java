...
public class DatosCanciones extends ArrayAdapter {
    ...
    public DatosCanciones(Context context, String tab, final View View22) {
        super(context, 0);
        ...
        jsArrayRequest = new JsonArrayRequest(Request.Method.GET,URL_BASE+tab,(String) null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        items = (ArrayList<DatosC>) parseJson(response);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        DatosC item = items.get(position);
    ...
    public List<DatosC> parseJson(JSONArray jsonObject) {
        // Variables locales
        List<DatosC> posts = new ArrayList<>();
